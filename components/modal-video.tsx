        ...
        <Dialog initialFocus={videoRef} onClose={() => setModalOpen(false)}>
          ...
          >
            <div className="max-w-6xl mx-auto h-full flex items-center">
              <Dialog.Panel className="w-full max-h-full aspect-video bg-black overflow-hidden rounded-lg">
                <video ref={videoRef} width={videoWidth} height={videoHeight} loop controls className="rounded-lg">

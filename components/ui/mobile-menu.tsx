    ...
    <div className="md:hidden">
      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          <li>
            <Link href="https://chatallais.com/chat" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>
              注册
            </Link>
          </li>
          <li>
